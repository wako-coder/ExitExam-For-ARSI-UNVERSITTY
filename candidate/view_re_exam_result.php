...
if($con)
 {
 $sql="select * from result where uid='$uid'  and program='Re_Exam'";
...
{	
	echo "<table border='1'>";
	echo"<tr> <th>User ID</th><th>Full Name</th><th>Dept</th><th>University</th><th>TotalQuestion </th><th>Wrong </th><th>Correct </th><th>Total(100%)</th><th>Status </th></tr>";
...
$fullname=$fname." ".$mname." ".$lname;
	...
	echo"you have seen during exam date";
}
     else
