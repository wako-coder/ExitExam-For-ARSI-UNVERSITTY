...
<a href="unreadd.php"><i class="icon-check"><font size="4px"> Unseen Request [&nbsp;<?php echo $coun?>&nbsp;]</font></i></a>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
$count_item=mysql_query("select * from notification where editor_status='read'" ) or die(mysql_error());
$count=mysql_num_rows($count_item);	
echo"<font color='red'>".($count)."</font>"; ?></p>							
									<?php
$query1 = mysql_query("select * from notification where editor_status='read' ORDER BY dates DESC")
or die(mysql_error());
?>

<?php
$sql = "select * from notification where editor_status='read' ORDER BY dates DESC";
