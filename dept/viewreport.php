...
overflow-x:scroll;">
<?php
$totlarecordexist=mysql_query("select * from candidate  where dept='$dept' and unversity='$univer' and year='$year'");
...
<tr><td colspan="12" style="text-align: center;font-weight: bold;font-size: 18px;">Graduate Student List Who Are Taken Exit Exam in <?php echo $univer;?> For Department Of <?php echo $dept; ?> In <?php echo $year; ?> E.C </td></tr>	
<tr>
<th>Role Number</th>
<th>Frist Name</th>	
<th>Middle Name</th>	
...
$program=$row["program"];	
		...
		$query="select * from candidate  where dept='$dept' and year ='$year' and cid='$candidateid' and unversity='$univer'";
