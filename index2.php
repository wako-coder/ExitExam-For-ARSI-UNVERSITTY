...
A web-based system provides access to a software system using a computer and  Network connection. Web based exit examination system is one of the systems which provide web based test exam services through network connection and it is control by Centralized administrator.
